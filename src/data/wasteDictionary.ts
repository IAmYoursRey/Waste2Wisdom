...
export const initialWasteData: WasteItem[] = [
  ...
  },
  {
    ...
    category: 'non-b3',
    categoryLabel: 'Non-B3 Terdaftar (Syarat Khusus)',
    ...
    safetyRating: 'caution',
    safetyDescription: 'Sesuai PP 22/2021, FABA dari PLTU non-stoker adalah Non-B3 Terdaftar. WAJIB menggunakan masker respirator (N95) untuk mencegah inhalasi debu silika halus.',
    requiredPPE: ['Respirator Debu FFP2/N95', 'Goggles Rapat', 'Sarung Tangan Karet Tebal'],
    legalCode: 'PP No. 22/2021: Limbah Non-B3 Terdaftar dengan Regulasi Pemanfaatan Terpantau',
